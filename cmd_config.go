...
func maidGetChatConfig(bot *tgbotapi.BotAPI, update tgbotapi.Update, db *maidDB, key string) (string, error) {
	...
	if key != "" {
		...
		msg_txt = msg_txt + "\nban\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.BanCmd)
		msg_txt = msg_txt + "\nconfig\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.ConfigCmd)
		msg_txt = msg_txt + "\nhelp\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.HelpCmd)
		msg_txt = msg_txt + "\ninfo\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.InfoCmd)
		msg_txt = msg_txt + "\nkick\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.KickCmd)
		msg_txt = msg_txt + "\nmute\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.MuteCmd)
		msg_txt = msg_txt + "\nremove\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.RemoveCmd)
		msg_txt = msg_txt + "\nrules\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.RulesCmd)
		msg_txt = msg_txt + "\nset\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.SetCmd)
		msg_txt = msg_txt + "\nsetrules\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.SetrulesCmd)
		msg_txt = msg_txt + "\nsetwelcome\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.SetwelcomeCmd)
		msg_txt = msg_txt + "\nstatus\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.StatusCmd)
		msg_txt = msg_txt + "\nunmute\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.UnmuteCmd)
		msg_txt = msg_txt + "\nunset\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.UnsetCmd)
		msg_txt = msg_txt + "\nupdate\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.UpdateCmd)
		msg_txt = msg_txt + "\nwarn\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.WarnCmd)
		msg_txt = msg_txt + "\nwelcome\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.WelcomeCmd)
		msg_txt = msg_txt + "\nremove\\_command\\: " + strconv.FormatBool(db.Chats[chat_id].Config.RemoveCmd)
